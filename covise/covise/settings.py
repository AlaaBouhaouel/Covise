...
AWS_S3_MEDIA_USE_SIGNED_URLS = config('AWS_S3_MEDIA_USE_SIGNED_URLS', default=True, cast=bool)
AWS_S3_MEDIA_URL_EXPIRY = config('AWS_S3_MEDIA_URL_EXPIRY', default=3600, cast=int)
